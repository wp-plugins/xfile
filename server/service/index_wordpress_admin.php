...
$XAPP_VFS_CONFIG_PATH = XAPP_BASEDIR . 'commander'. DIRECTORY_SEPARATOR . 'vfs.php';
$repositoryRoot = XApp_Path_Utils::securePath(XApp_Path_Utils::normalizePath($repositoryRoot));

//xfile - repo root, back-compat :
$xFileRepositoryRoot = XApp_Variable_Mixin::replaceResourceVariables($repositoryRoot,
    array(
        'root' => $repositoryRoot,
