...
class XApp_Commander_Bootstrap extends XApp_Bootstrap implements Xapp_Singleton_Interface
{
    ...
    (
        ...
        self::ALLOW_PLUGINS             => XAPP_TYPE_BOOL,
    ...
    /***
     * Return resources by run-time configuration
     * @param $plugins
...
/*
    ...
    private function setupRPC(){
         ...
         * Filtered methods
         */
        $ignoredRPCMethods = array('load', 'setup','log','onBeforeCall','onAfterCall','dumpObject','applyFilter','getLastJSONError','cleanUrl','rootUrl','siteUrl','getXCOption','getIndexer','getIndexOptions','getIndexOptions','indexDocument','onBeforeSearch','toDSURL','searchTest');
    ...
    public function setupService(){
        ...
        )
        {
            ...
            $fileConf = xapp_get_option(self::XFILE_CONF);
            $xappFileService->_setRootDirectory(xapp_get_option(Xapp_FileService::REPOSITORY_ROOT,$fileConf));
    ...
    public function setup(){
        ...
        $opt = array
        (
            XApp_App_Commander::DOC_ROOT_PATH       =>xapp_get_option(self::APPDIR,$this),//complete url to the client app doc root : http://192.168.1.37/joomla352//administrator/components/com_xappcommander/client/
            XApp_App_Commander::DOC_ROOT            =>xapp_get_option(self::DOC_ROOT,$this),//complete absolute path : /mnt/ssd2/htdocs/joomla352/administrator/components/com_xappcommander//client/
            XApp_App_Commander::APP_NAME            =>xapp_get_option(self::APP_NAME,$this),//system application name
            XApp_App_Commander::APP_FOLDER          =>xapp_get_option(self::APP_FOLDER,$this),//path prefix to the client application
            ...
            XApp_App_Commander::RESOURCE_RENDERER   =>$xappResourceRenderer///components/com_xappcommander/index.php?option=com_xappcommander&view=rpc///components/com_xappcommander/index.php?option=com_xappcommander&view=rpc
        );
