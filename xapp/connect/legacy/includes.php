 ...
 * RPC Service Class
 */
require_once(XAPP_CONNECT_LEGACY . "SQL2JSONService.php");

/***
 * Maps global functions to service class
 */
require_once(XAPP_CONNECT_LEGACY . "serviceRouter.php");
/**
 * Database includes
 */
 ...
 * Custom RPC error
 */
include (XAPP_CONNECT.'RpcError.php');

/***
 * Functions for being used in schema templates
 */
include (XAPP_CONNECT_LEGACY.'SchemaFuncs.php');

/***
 * Functions for being used in schema templates
 */
include (XAPP_CONNECT_LEGACY.'SchemaFuncsJoomla.php');

/***
 * Functions for being used in schema templates
 */
include (XAPP_CONNECT_LEGACY.'SchemaFuncsDate.php');


/**
 * The schema processor
 */
require_once(XAPP_CONNECT_LEGACY . "SchemaProcessor.php");

/**
 * The schema processor interface
 */
require_once(XAPP_CONNECT_LEGACY . "ISchemaProcessor.php");
