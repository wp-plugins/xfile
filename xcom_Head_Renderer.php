...
if($xcomParameters){
	...
	$XAPP_XFILE_CONFIG_ARRAY['JQTHEME']= XApp_Service_Utils::_getKey('theme',$XAPP_XFILE_CONFIG_ARRAY['JQTHEME']);
	...
	$XAPP_JQUERY_THEME = XApp_Service_Utils::_getKey('theme',$XAPP_XFILE_CONFIG_ARRAY['JQTHEME']);
...
<style>
	.claro{
		font-size: <?php echo $xcomParameters['GLOBALFONTSIZE']?> !important;
	}

	.actionToolbarButtonElusive{
		font-size: <?php echo $xcomParameters['ICONFONTSIZE']?> !important;
	}
</style>