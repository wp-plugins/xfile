define([
    ...
    function (TemplatedWidgetBase,CSSMixin,_StyleMixin,_InsertionMixin,HTMLTemplateMixin,utils,types,factory,cookie,json,ShellRunView)
    {
        return dojo.declare("Shell.xfile.views.ShellView", [TemplatedWidgetBase,CSSMixin,_StyleMixin,HTMLTemplateMixin,_InsertionMixin],
            {
                config:null,
                ctx:null,
