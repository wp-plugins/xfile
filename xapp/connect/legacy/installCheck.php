...
/***
 * You better check or disable apc in .htacces
 */
...
function xapp_try_require_once($path,$message=""){
    echo $message . " :: trying to require once" . $path . "<br/>";
    require_once($path);

}
function xapp_try_include($path,$message=""){
    echo $message . " :: " . "trying to include " . $path . "<br/>";
    include($path);

}
function xapp_try_include_once($path,$message=""){
    echo $message . " :: " . "trying to include once" . $path . "<br/>";
    include_once($path);
 ...
 * includes, wp & joomla
 */
xapp_try_require_once(XAPP_BASEDIR . "includes.php");
/***
 * system constants
 */
xapp_try_require_once(XAPP_BASEDIR . "defines.php");

/***
 * wrapper for xapp_conf
 */
xapp_try_include(XAPP_BASEDIR . "conf.php");//conf wrapper

/***
 * ?
 */
xapp_try_include(XAPP_BASEDIR . XAPP_CONNECT_CONFIG);//conf data
 ...
 */
xapp_try_include_once(XAPP_LIB . "lucene/LuceneIndexer.php");
...
echo "  Setup template engine done<br/>";
...
{
    xapp_try_require_once(XAPP_BASEDIR . "jincludes.php");
    xapp_try_include_once(XAPP_LIB . "db/JoomlaDB.php");
    xapp_try_include_once(XAPP_LIB . "joomla/XAppJoomlaAuth.php");
}

if( (bool)xc_conf(XC_CONF_WORDPRESS))
{
    xapp_try_include('./wpincludes.php');
    xapp_try_include_once(XAPP_LIB . "wordpress/XAppWordpressAuth.php");
}
echo "<b>setup lucene</b><br/>";
xapp_try_include_once(XAPP_LIB . "lucene/LuceneIndexer.php");
set_include_path(get_include_path().PATH_SEPARATOR.XAPP_LIB."/lucene");
...
if(!function_exists("search")){
    ...
    echo "function search already exists<br/>";
}
...
try{
    ...
    echo "<b>setup xapp-php-conf</b><br/>";
    //setup xapp-php
    $conf = array
    (
