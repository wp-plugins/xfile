define([
    ...
    function (array, declare, html, on,lang,TemplatedWidgetBase,CSSMixin,_StyleMixin,_InsertionMixin,
              HTMLTemplateMixin,domClass, domGeometry, domStyle,win,utils,types,factory,ContentPane,RemoteEditor,MD5,cookie,json)
    {
        return dojo.declare("Sandbox.xfile.views.Sandbox", [TemplatedWidgetBase,CSSMixin,_StyleMixin,HTMLTemplateMixin,_InsertionMixin],
            {
                config:null,
                ctx:null,
                ...
                templateString:
                    "<div>"+
                        "<div data-dojo-attach-point='layoutMain' data-dojo-type='xfile.layout.BorderContainer' data-dojo-props=\"design:'headline',cookieName:'${!cookieName}'\" class='layoutMain '>"+
