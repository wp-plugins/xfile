define([
    ...
    function (declare, TemplatedWidgetBase,CSSMixin,_StyleMixin,_InsertionMixin,HTMLTemplateMixin,domClass, factory,KeyboardHandler,History)
    {
        return declare("Shell.xfile.widgets.Console", [TemplatedWidgetBase,CSSMixin,_StyleMixin,HTMLTemplateMixin,_InsertionMixin,KeyboardHandler,History],
            {
                delegate:null,
                value:null,
                editNode:null,
