...
define('XC_OPERATION_DOWNLOAD_STR','download');
...
define('XC_OPERATION_UPLOAD_STR','upload');
define('XC_OPERATION_READ_STR','getContent');
define('XC_OPERATION_WRITE_STR','setContent');
define('XC_OPERATION_FILE_UPDATE_STR','fileUpdate');
